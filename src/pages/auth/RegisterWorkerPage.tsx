...
export function RegisterWorkerPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Register to access your portable health records"
    >
      <div className="mb-6">
        <div className="inline-flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-primary-600 to-primary-700 text-white shadow-sm">
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-ink-500">
          ...
          <Link to="/login/worker" className="font-semibold text-primary-700 hover:text-primary-800">
            Sign in
          </Link>
        </p>
      </div>
