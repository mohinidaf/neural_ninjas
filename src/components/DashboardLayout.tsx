...
export function DashboardLayout({ role, children }: DashboardLayoutProps) {
  ...
  const displayName = profile?.full_name || roleUser[role].name;
  const displaySub = role === 'worker' && profile ? (profile as WorkerProfile).health_id || roleUser[role].sub : roleUser[role].sub;
